...
export function ChatView({
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-background">
      ...
      <div className="border-t border-border bg-surface/80 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl">
        <div className="mx-auto w-full max-w-3xl px-2.5 py-2.5 sm:px-6 sm:py-4">
          {attachments.length ? (
